    ...
    if key.iloc[i]['latitude'] > 0:
    	markers.append(
	    	dl.Marker(title=key.iloc[i]['name_store'],
	    		...
	    		children=[
	    			dl.Tooltip("{} > {} > ${} ".format(key.iloc[i]['name_store'], key.iloc[i]['name'], key.iloc[i]['price']))
	    		]
	    	)
	    )
...
dash.register_page(__name__, path='/', name='SUNKIST')
layout = html.Div(children=[
	html.Div(className='motherboard', children=[
		html.Div(className='child-side', children=[
			html.Div(className='child-child', style={'backgroundColor':'#A3E2FF'},  children=[
				html.Div(className='child-text', children=[
					html.H3("30%", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
			...
			html.Div(className='child-child', style={'backgroundColor':'#5BCBFF'},  children=[
				html.Div(className='child-text', children=[
					html.H3("Mad Men: Time & Life (2015)", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
			...
			html.Div(className='child-child', style={'backgroundColor':'#23B8FD'}, children=[
				html.Div(className='child-text', children=[
					html.H3("Phyu Phyu Kyaw", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
			...
			html.Div(className='child-child', style={'backgroundColor':'#0092D6'},  children=[
				html.Div(className='child-text', children=[
					html.H3("70%", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
			...
			html.Div(className='child-child', style={'backgroundColor':'#0072A7'}, children=[
				html.Div(className='child-text', children=[
					html.H3("Oklahoma", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
			...
			html.Div(className='child-child', style={'backgroundColor':'#004F74'}, children=[
				html.Div(className='child-text', children=[
					html.H3("Canada Dry", style={'color':'#FFF', 'font-weight': '900', 'padding-bottom':'0.5rem'}),
		...
		html.Div(className='child-main', children=[
			dmc.Breadcrumbs(children=[dcc.Link("Home", href="/"), dcc.Link("PUP", href="/"), dcc.Link("Sunkist", href="#")]),
			...
			html.Div(className='row-1', children=[
				html.Div(className="gender-div", children=[
					...
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=genderChart, responsive=True)
				]),
				html.Div(className="race-div", children=[
					html.H4(className="chart-title", children=['Race']),
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=raceChart, responsive=True)
				]),
				html.Div(className="income-div", children=[
					html.H4(className="chart-title", children=['Income']),
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=incomeChart, responsive=True)
				])#
			]),
			html.Div(className='row-2', children=[
				html.Div(className="age-div", children=[
					html.H4(className="chart-title", children=['Age']),
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=ageChart, responsive=True)
				]),
				html.Div(className="marital-div", children=[
					html.H4(className="chart-title", children=['Gender']),
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=maritalChart, responsive=True)
				]),
				html.Div(className="school-div", children=[
					html.H4(className="chart-title", children=['Education']),
					dcc.Graph(style={'height':'51vh','padding':'1rem'}, figure=schoolChart, responsive=True)
				])
			])
		])
	]),
	...
	html.Div(className='salesboard', children=[
		...
		html.Div(className='groups-win', children=[
			...
			html.Div(className='groups', children=[
				html.Span(className='rank-titles', children=["#1st"]),
			...
			html.Div(className='groups', children=[
				html.Span(className='rank-titles', children=["#2nd"]),
			...
			html.Div(className='groups', children=[
				html.Span(className='rank-titles', children=["#3rd"]),
			...
			html.Div(className='groups', children=[
				html.Span(className='rank-titles', children=["#4th"]),
			...
			html.Div(className='groups', children=[
				html.Span(className='rank-titles', children=["#5th"]),
...
@callback([Output('priceChart-sunkist','figure'),
	Output('storeChart-sunkist','figure'),
	Output('tablePrice-sunkist','children')],Input('cont-sunkist','value'))
